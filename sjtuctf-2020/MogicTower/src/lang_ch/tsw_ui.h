const wchar_t szAppName[] = L"Mogic Tower";
const wchar_t szTitle[]=			L"膜塔";
...
const wchar_t szCell_BraveMan[]=		L"长者";
const wchar_t szCell_Thief[]=			L"香港记者";
const wchar_t szCell_Princess[]=		L"夫人";
const wchar_t szCell_OldMan[]=			L"老头";
const wchar_t szCell_Merchant[]=		L"奸商";
const wchar_t szCell_Altar[]=			L"祭坛";

const wchar_t szCell_Stair[]=			L"楼梯";
const wchar_t szCell_FakeWall[]=		L"墙";
const wchar_t szCell_FakeRoad[]=		L"路";
...
const wchar_t szScreen_IntroD[]=		L"长者去救夫人。";
const wchar_t szScreen_Coma1[]=			L"0";
const wchar_t szScreen_Coma2[]=			L"o";
const wchar_t szScreen_Coma3[]=			L"p";
const wchar_t szScreen_Coma4[]=			L"s{";
 wchar_t szScreen_Finale1[8] = L"_FAKE__";
 wchar_t szScreen_Finale2[6] = L"_FLAG";
 wchar_t szScreen_Finale3[7] = L"_FAKE}";
const wchar_t szScreen_Finale4[]=		L"传说塔里隐藏了一段数字，找到它的人才能拼出完整的弗拉格……";
...
const wchar_t szDialog_Story3F1[]=		L"欢迎来到膜塔。\n你是第1926个胆敢闯入我的塔的人。\n你将直面我的守卫们，\n要是你侥幸活下来的话，\n我将破例和你单挑，\n这就是你的命运。";
...
const wchar_t szDialog_Story32F1[]=		L"能打败第一第二区域头目上来，你的确是个长者，\n不过现在游戏结束了。\n此时此地，我要亲手击败你，投降吧！";
...
const wchar_t szDialog_Story42F1[]=		L"哦！魔王长官，我没能抓住那个长者。\n请饶了我。";
...
const wchar_t szDialog_Thief29F3[]=		L"最终的头目和被抓的夫人肯定在这个区域。\n嗯，我在想我们是不是应该等等再和他战斗。";
...
const wchar_t szDialog_OldMan6F[]=		L"如果你从奸商那里买东西，\n你将会从他那听到重要的信息。";
...
const wchar_t szDialog_Merchant6FB[]=		L"这个膜塔有50层，每10层为1个区，每个区都有头目。\n如果你不打败他们，你不能上楼。";
