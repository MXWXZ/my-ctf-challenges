...
const wchar_t szScreen_Coma4[]=			L"and get great wisdom.";
 wchar_t szScreen_Finale1[]=		L"The long war has come to an end,\nthe vanity tower fell down.";
 wchar_t szScreen_Finale2[]=		L"Gods have returned to heaven.\nThe soldiers have returned to the ground.";
 wchar_t szScreen_Finale3[]=		L"The present has changed to the past.\nThis trip has coming to the past.";
