int killMonster(int x,int y){//return gold obtained
	...
	case 10:
		...
		if (temp==9&&(y>=3&&y<=5)&&(x>=4&&x<=6)){
			target=CT_SkeletonA;
			dialogY=6;
			swprintf(dialogbuf,tbuflen,szDialog_Story10F2);
			story=ST_10F2;
			break;
		}
		if (y==0&&x==5){
			dialogY=6;
			swprintf(dialogbuf,tbuflen,szDialog_Story10F3);
			story=ST_10F3;
			break;
		}
		break;
	...
	case 20:
		if (y==5&&x==5){
			dialogY=0;
			swprintf(dialogbuf,tbuflen,szDialog_Story20F2);
			story=ST_20F2;
			break;
		}
		break;
	...
	case 49:
		...
		if (temp==4){
			...
			if (temp==4&&((y==1&&x==5)||(y==2&&x==4)||(y==2&&x==6)||(y==3&&x==5))){
				...
				target=CT_Zeno49B;
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=7;
				swprintf(dialogbuf,tbuflen,szDialog_Story49F2);
				story=ST_49F2;
			}
			break;
		}
...
int touch(int x,int y){//return 0 to block moving
	...
	if (cell[type].flag&CF_EnemyMask){
		...
		if (stmain.attack*getAttackMul(type)<=cell[type].defend){
			swprintf(statusbuf,tbuflen,szStatus_BattleForbidden,cell[type].name);
			return 0;
		}
		...
		if (stmain.life<=0){
			...
			swprintf(statusbuf,tbuflen,szStatus_BattleLose,cell[type].name);
			return 0;
		}
		temp=killMonster(x,y);
		playSound(WAV_Attack);
		swprintf(statusbuf,tbuflen,szStatus_BattleWinA,cell[type].name,temp);
		return 1;
	}
	switch (type){
	case CT_Thief:
	case CT_ThiefTalked:
		...
		case 2:
			if (y==6&&x==2){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=1;
				swprintf(dialogbuf,tbuflen,szDialog_Thief2F1);
				story=ST_Thief2F1;
				break;
			}
			if (y==7&&x==0){
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=1;
				swprintf(dialogbuf,tbuflen,szDialog_Thief2F2);
				story=ST_Thief2F2;
				break;
			}
			if (y==10&&x==10){
				...
				dialogY=1;
				if (type==CT_Thief){
					swprintf(dialogbuf,tbuflen,szDialog_Thief2F3);
					story=ST_Thief2F3;
				}else{
					swprintf(dialogbuf,tbuflen,szDialog_Thief2F4);
					story=ST_Thief2F4;
				}
				break;
			}
		...
		case 15:
			if (y==0&&x==8){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=2;
				swprintf(dialogbuf,tbuflen,szDialog_Thief15F);
				story=ST_Thief15F;
				break;
			}
			break;
		case 29:
			if (y==3&&x==5){
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=6;
				swprintf(dialogbuf,tbuflen,szDialog_Thief29F1);
				story=ST_Thief29F1;
				break;
			}
			if (y==1&&x==6){
				...
				dialogY=4;
				if (type==CT_Thief){
					swprintf(dialogbuf,tbuflen,szDialog_Thief29F2);
					story=ST_Thief29F2;
				}else{
					swprintf(dialogbuf,tbuflen,szDialog_Thief29F3);
					story=ST_Thief29F3;
				}
				break;
			}
		...
		case 35:
			if (y==9&&x==4){
				...
				dialogY=1;
				if (type==CT_Thief){
					swprintf(dialogbuf,tbuflen,szDialog_Thief35F1);
					story=ST_Thief35F1;
				}else{
					swprintf(dialogbuf,tbuflen,szDialog_Thief35F2);
					story=ST_Thief35F2;
				}
				break;
			}
		...
		case 50:
			if (y==4&&x==5){
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=7;
				swprintf(dialogbuf,tbuflen,szDialog_Thief50F);
				story=ST_Thief50F;
				break;
			}
			break;
	...
	case CT_PrincessTalked:
		...
		swprintf(statusbuf,tbuflen,szStatus_Story);
		dialogY=0;
		swprintf(dialogbuf,tbuflen,szDialog_Princess1);
		story=ST_Princess1;
		return 0;
	case CT_OldMan:
	case CT_OldManTalked:
		...
		if (stmain.floor==2&&y==6&&x==10){
			dialogY=1;
			if (type==CT_OldMan){
				swprintf(statusbuf,tbuflen,szStatus_Merchant);
				swprintf(dialogbuf,tbuflen,szDialog_OldMan2F);
				story=ST_OldMan2F;
			}else{
				swprintf(statusbuf,tbuflen,szStatus_Story);
				swprintf(dialogbuf,tbuflen,szDialog_OldManT);
				story=ST_OldManT;
			}
			return 0;
		}
		...
		case 3:
			if (y==3&&x==10){
				...
				dialogY=6;
				if (type==CT_OldMan){
					swprintf(dialogbuf,tbuflen,szDialog_OldMan3F);
					story=ST_OldMan3F;
				}else{
					swprintf(dialogbuf,tbuflen,szDialog_OldManT);
					story=ST_OldManT;
		...
		case 4:
			if (y==0&&x==9){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=3;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan4F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 6:
			if (y==7&&x==3){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=1;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan6F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 16:
			if (y==10&&x==0){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=4;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan16F1:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			if (y==10&&x==10){
				...
				dialogY=4;
				if (type==CT_OldMan){
					swprintf(dialogbuf,tbuflen,szDialog_OldMan16F2);
					story=ST_OldMan16F2;
				}else{
					swprintf(dialogbuf,tbuflen,szDialog_OldManT);
					story=ST_OldManT;
		...
		case 18:
			if (y==1&&x==2){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=4;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan18F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 21:
			if (y==5&&x==5){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=7;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan21F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 23:
			if (y==10&&x==10){
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=4;
				swprintf(dialogbuf,tbuflen,szDialog_OldMan23F);
				story=ST_OldManT;
				break;
			}
			break;
		case 27:
			if (y==0&&x==5){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=3;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan27F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 31:
			if (y==0&&x==10){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=3;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan31F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 33:
			if (y==2&&x==3){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=5;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan33F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 36:
			if (y==0&&x==0){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=3;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan36F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 37:
			if (y==10&&x==0){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=4;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan37F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 39:
			if (y==10&&x==0){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=4;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan39F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 42:
			if (y==3&&x==0){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=6;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan42F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 45:
			if (y==5&&x==8){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=0;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan45F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 46:
			if (y==8&&x==7){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=2;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan46F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
		case 48:
			if (y==1&&x==2){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=4;
				swprintf(dialogbuf,tbuflen,type==CT_OldMan?szDialog_OldMan48F:szDialog_OldManT);
				story=ST_OldManT;
				break;
			}
			break;
	...
	case CT_MerchantTalked:
		...
		case 2:
			if (y==3&&x==10){
				...
				if (type==CT_Merchant){
					...
					swprintf(dialogbuf,tbuflen,szDialog_Merchant2F);
					story=ST_Merchant2F;
				}else{
					swprintf(dialogbuf,tbuflen,szDialog_Merchant2FB);
					story=ST_MerchantT;
				}
				break;
			}
		case 6:
			if (y==3&&x==7){
				...
				if (type==CT_Merchant){
					swprintf(statusbuf,tbuflen,szStatus_Merchant);
					swprintf(dialogbuf,tbuflen,szDialog_Merchant6F);
					story=ST_Merchant6F;
				}else{
					stmain.map[stmain.floor][y][x]=CT_MerchantTalked;
					stmain.notes|=1<<3;
					swprintf(statusbuf,tbuflen,szStatus_Story);
					swprintf(dialogbuf,tbuflen,type==CT_MerchantBought?szDialog_Merchant6FB:szDialog_MerchantT);
					story=ST_MerchantT;
				}
				break;
			}
		...
		case 7:
			if (y==0&&x==5){
				...
				if (type==CT_Merchant){
					swprintf(statusbuf,tbuflen,szStatus_Merchant);
					swprintf(dialogbuf,tbuflen,szDialog_Merchant7F);
					story=ST_Merchant7F;
				}else{
					stmain.map[stmain.floor][y][x]=CT_MerchantTalked;
					stmain.notes|=1<<4;
					swprintf(statusbuf,tbuflen,szStatus_Story);
					swprintf(dialogbuf,tbuflen,type==CT_MerchantBought?szDialog_Merchant7FB:szDialog_MerchantT);
					story=ST_MerchantT;
				}
				break;
			}
		...
		case 12:
			if (y==0&&x==0){
				...
				if (type==CT_Merchant){
					swprintf(statusbuf,tbuflen,szStatus_Merchant);
					swprintf(dialogbuf,tbuflen,szDialog_Merchant12F1);
					story=ST_Merchant12F1;
				}else{
					stmain.map[stmain.floor][y][x]=CT_MerchantTalked;
					stmain.notes|=1<<5;
					swprintf(statusbuf,tbuflen,szStatus_Story);
					swprintf(dialogbuf,tbuflen,type==CT_MerchantBought?szDialog_Merchant12FB:szDialog_MerchantT);
					story=ST_MerchantT;
				}
				break;
			}
			if (y==0&&x==10){
				swprintf(statusbuf,tbuflen,szStatus_Merchant);
				dialogY=3;
				swprintf(dialogbuf,tbuflen,szDialog_Merchant12F2);
		...
		case 15:
			if (y==10&&x==10){
				...
				if (type==CT_Merchant){
					swprintf(statusbuf,tbuflen,szStatus_Merchant);
					swprintf(dialogbuf,tbuflen,szDialog_Merchant15F);
					story=ST_Merchant15F;
				}else{
					stmain.map[stmain.floor][y][x]=CT_MerchantTalked;
					stmain.notes|=1<<6;
					swprintf(statusbuf,tbuflen,szStatus_Story);
					swprintf(dialogbuf,tbuflen,type==CT_MerchantBought?szDialog_Merchant15FB:szDialog_MerchantT);
					story=ST_MerchantT;
				}
				break;
			}
		...
		case 28:
			if (y==3&&x==7){
				swprintf(statusbuf,tbuflen,szStatus_Merchant);
				dialogY=6;
				swprintf(dialogbuf,tbuflen,szDialog_Merchant28F);
		...
		case 31:
			if (y==10&&x==0){
				...
				if (type==CT_Merchant){
					swprintf(statusbuf,tbuflen,szStatus_Merchant);
					swprintf(dialogbuf,tbuflen,szDialog_Merchant31F);
					story=ST_Merchant31F;
				}else{
					stmain.map[stmain.floor][y][x]=CT_MerchantTalked;
					stmain.notes|=1<<12;
					swprintf(statusbuf,tbuflen,szStatus_Story);
					swprintf(dialogbuf,tbuflen,type==CT_MerchantBought?szDialog_Merchant31FB:szDialog_MerchantT);
					story=ST_MerchantT;
				}
				break;
			}
		...
		case 38:
			if (y==1&&x==4){
				...
				if (type==CT_Merchant){
					swprintf(statusbuf,tbuflen,szStatus_Merchant);
					swprintf(dialogbuf,tbuflen,szDialog_Merchant38F);
					story=ST_Merchant38F;
				}else{
					stmain.map[stmain.floor][y][x]=CT_MerchantTalked;
					stmain.notes|=1<<16;
					swprintf(statusbuf,tbuflen,szStatus_Story);
					swprintf(dialogbuf,tbuflen,type==CT_MerchantBought?szDialog_Merchant38FB:szDialog_MerchantT);
					story=ST_MerchantT;
				}
				break;
			}
		...
		case 39:
			if (y==1&&x==8){
				...
				if (type==CT_Merchant){
					swprintf(statusbuf,tbuflen,szStatus_Merchant);
					swprintf(dialogbuf,tbuflen,szDialog_Merchant39F);
					story=ST_Merchant39F;
				}else{
					stmain.map[stmain.floor][y][x]=CT_MerchantTalked;
					stmain.notes|=1<<18;
					swprintf(statusbuf,tbuflen,szStatus_Story);
					swprintf(dialogbuf,tbuflen,type==CT_MerchantBought?szDialog_Merchant39FB:szDialog_MerchantT);
					story=ST_MerchantT;
				}
				break;
			}
		...
		case 45:
			if (y==2&&x==8){
				...
				if (type==CT_Merchant){
					swprintf(statusbuf,tbuflen,szStatus_Merchant);
					swprintf(dialogbuf,tbuflen,szDialog_Merchant45F);
					story=ST_Merchant45F;
				}else{
					stmain.map[stmain.floor][y][x]=CT_MerchantTalked;
					stmain.notes|=1<<21;
					swprintf(statusbuf,tbuflen,szStatus_Story);
					swprintf(dialogbuf,tbuflen,type==CT_MerchantBought?szDialog_Merchant45FB:szDialog_MerchantT);
					story=ST_MerchantT;
				}
				break;
			}
		...
		case 47:
			if (y==1&&x==4){
				...
				if (type==CT_Merchant){
					swprintf(statusbuf,tbuflen,szStatus_Merchant);
					swprintf(dialogbuf,tbuflen,szDialog_Merchant47F);
					story=ST_Merchant47F;
				}else{
					stmain.map[stmain.floor][y][x]=CT_MerchantTalked;
					stmain.notes|=1<<23;
					swprintf(statusbuf,tbuflen,szStatus_Story);
					swprintf(dialogbuf,tbuflen,type==CT_MerchantBought?szDialog_Merchant47FB:szDialog_MerchantT);
					story=ST_MerchantT;
				}
				break;
			}
	...
	case CT_Altar:
		...
		swprintf(statusbuf,tbuflen,szStatus_Altar);
		dialogY=3;
		swprintf(dialogbuf,tbuflen,szDialog_Altar,temp,stmain.altar*100,(stmain.floor+9)/10*2,(stmain.floor+9)/10*4);
		story=ST_Altar;
		return 0;
	case CT_UpStair:
		target=type;
		goUpStair();
		swprintf(statusbuf,tbuflen,szStatus_UpStair);
		return 0;
	case CT_DownStair:
		target=type;
		goDownStair();
		swprintf(statusbuf,tbuflen,szStatus_DownStair);
		return 0;
	case CT_FakeWall:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Open);
		swprintf(statusbuf,tbuflen,szStatus_WallCollapse);
		return 0;
	case CT_FakeRoad:
		target=type;
		...
		playSound(WAV_Open);
		swprintf(statusbuf,tbuflen,szStatus_WallAppear);
		return 0;
	case CT_RedDoor:
		target=type;
		if (stmain.key[KEY_Red]>0){
			...
			--stmain.key[KEY_Red];
			playSound(WAV_Open);
			swprintf(statusbuf,tbuflen,szStatus_RedDoorOpen);
			return 0;
		}
		swprintf(statusbuf,tbuflen,szStatus_RedDoorBlock);
		return 0;
	case CT_BlueDoor:
		target=type;
		if (stmain.key[KEY_Blue]>0){
			...
			--stmain.key[KEY_Blue];
			playSound(WAV_Open);
			swprintf(statusbuf,tbuflen,szStatus_BlueDoorOpen);
			return 0;
		}
		swprintf(statusbuf,tbuflen,szStatus_BlueDoorBlock);
		return 0;
	case CT_YellowDoor:
		target=type;
		if (stmain.key[KEY_Yellow]>0){
			...
			swprintf(statusbuf,tbuflen,szStatus_YellowDoorOpen);
			if (stmain.floor==39){
				temp=0;
		...
		swprintf(statusbuf,tbuflen,szStatus_YellowDoorBlock);
		return 0;
	case CT_Lava:
		target=type;
		swprintf(statusbuf,tbuflen,szStatus_LavaBlock);
		return 0;
	case CT_RedKey:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		++stmain.key[KEY_Red];
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetRedKey);
		return 1;
	case CT_BlueKey:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		++stmain.key[KEY_Blue];
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetBlueKey);
		return 1;
	case CT_YellowKey:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		++stmain.key[KEY_Yellow];
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetYellowKey);
		return 1;
	case CT_RedElixir:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		stmain.life+=temp;
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetRedElixir,temp);
		return 1;
	case CT_BlueElixir:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		stmain.life+=temp;
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetBlueElixir,temp);
		return 1;
	case CT_RedCrystal:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		stmain.attack+=temp;
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetRedCrystal,temp);
		return 1;
	case CT_BlueCrystal:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		stmain.defend+=temp;
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetBlueCrystal,temp);
		return 1;
	case CT_IronSword:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetWeapon,szCell_IronSword,temp);
		return 1;
	case CT_SilverSword:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetWeapon,szCell_SilverSword,temp);
		return 1;
	case CT_SwordOfKnight:
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetWeapon,szCell_SwordOfKnight,temp);
		return 1;
	case CT_HolySword:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		stmain.attack+=temp;
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetWeapon,szCell_HolySword,temp);
		return 1;
	case CT_SacredSword:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		stmain.attack+=temp;
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetWeapon,szCell_SacredSword,temp);
		return 1;
	case CT_IronShield:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetArmor,szCell_IronShield,temp);
		return 1;
	case CT_SilverShield:
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetArmor,szCell_SilverShield,temp);
		return 1;
	case CT_ShieldOfKnight:
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetArmor,szCell_ShieldOfKnight,temp);
		return 1;
	case CT_HolyShield:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetArmor,szCell_HolyShield,temp);
		return 1;
	case CT_SacredShield:
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetArmor,szCell_SacredShield,temp);
		return 1;
	case CT_OrbOfHero:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_OrbOfHero);
		return 1;
	case CT_OrbOfWisdom:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_OrbOfWisdom);
		return 1;
	case CT_OrbOfFlying:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_OrbOfFlying);
		return 1;
	case CT_Cross:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetCross);
		return 1;
	case CT_MagicElixir:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_MagicElixir);
		return 1;
	case CT_MagicMattock:
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_MagicMattock);
		return 1;
	case CT_DestructibleBall:
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_DestructibleBall);
		return 1;
	case CT_WarpStaff:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_WarpStaff);
		return 1;
	case CT_WingsToFlyUp:
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_WingsToFlyUp);
		return 1;
	case CT_WingsToFlyDown:
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_WingsToFlyDown);
		return 1;
	case CT_DragonSlayer:
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetDragonSlayer);
		return 1;
	case CT_SnowCrystal:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_SnowCrystal);
		return 1;
	case CT_MagicKey:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_MagicKey);
		return 1;
	case CT_SuperMagicMattock:
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetItem,szCell_SuperMagicMattock);
		return 1;
	case CT_LuckyGold:
		target=type;
		stmain.map[stmain.floor][y][x]=CT_Null;
		...
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_GetLuckyGold);
		return 1;
	default:
		;
	}
	...
	if (moved){
		if (stmain.armor<ARM_SacredShield){
			...
			if (temp>0){
				...
				if (stmain.life<=0){
					stmain.life=0;
					swprintf(statusbuf,tbuflen,szStatus_MagicLose);
				}else{
					swprintf(statusbuf,tbuflen,szStatus_MagicAttack,temp);
				}
			}
		}
		if (stmain.floor==47){
	...
	if (stmain.map[stmain.floor][stmain.y][stmain.x]==CT_CellTag){
		...
		case 3:
			if (stmain.y==8&&stmain.x==4){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=1;
				swprintf(dialogbuf,tbuflen,szDialog_Story3F1);
				story=ST_3F1;
				break;
			}
			break;
		case 10:
			if (stmain.y==4&&stmain.x==5){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=6;
				swprintf(dialogbuf,tbuflen,szDialog_Story10F1);
				story=ST_10F1;
				break;
			}
			if (stmain.y==8&&stmain.x==5){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=2;
				swprintf(dialogbuf,tbuflen,szDialog_Story10F4);
				story=ST_10F4;
				break;
			}
			break;
		...
		case 20:
			if (stmain.y==7&&stmain.x==5){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=0;
				swprintf(dialogbuf,tbuflen,szDialog_Story20F1);
				story=ST_20F1;
				break;
			}
			break;
		case 24:
			if (stmain.y==0&&stmain.x==5){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=7;
				swprintf(dialogbuf,tbuflen,szDialog_Story50F1);
				story=ST_50F1;
				break;
			}
			break;
		case 25:
			if (stmain.y==8&&stmain.x==5){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=0;
				swprintf(dialogbuf,tbuflen,szDialog_Story25F);
				story=ST_25F;
				break;
			}
			break;
		...
		case 32:
			if (stmain.y==9&&stmain.x==5){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=0;
				swprintf(dialogbuf,tbuflen,szDialog_Story32F1);
				story=ST_32F1;
				break;
			}
			break;
		...
		case 40:
			if (stmain.y==6&&stmain.x==5){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=7;
				swprintf(dialogbuf,tbuflen,szDialog_Story40F1);
				story=ST_40F1;
				break;
			}
			break;
		case 42:
			if (stmain.y==9&&stmain.x==5){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=0;
				swprintf(dialogbuf,tbuflen,szDialog_Story42F1);
				story=ST_42F1;
				break;
			}
			break;
		...
		case 49:
			if (stmain.y==5&&stmain.x==5){
				...
				swprintf(statusbuf,tbuflen,szStatus_Story);
				dialogY=7;
				swprintf(dialogbuf,tbuflen,szDialog_Story49F1);
				story=ST_49F1;
				break;
			}
			break;
