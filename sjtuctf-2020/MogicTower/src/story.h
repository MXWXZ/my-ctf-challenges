...
int defendMonster(int x,int y){//return 0 to block story change
	...
	if (temp<0){
		...
		swprintf(statusbuf,tbuflen,szStatus_BattleEndless,cell[type].name);
	...
	stmain.gold+=temp;
	playSound(WAV_Attack);
	swprintf(statusbuf,tbuflen,szStatus_BattleWinD,cell[type].name,temp);
	return 1;
}
...
int storyProgress(){//return 1 to redraw
	...
	case ST_3F1:
		...
		swprintf(dialogbuf,tbuflen,szDialog_Story3F2);
		story=ST_3F2;
		return 1;
	case ST_3F2:
		target=CT_Null;
	...
	case ST_Coma4:
		...
		dialogY=1;
		swprintf(dialogbuf,tbuflen,szDialog_Wake1);
		story=ST_Wake1;
		return 1;
	case ST_Wake1:
		swprintf(dialogbuf,tbuflen,szDialog_Wake2);
		story=ST_Wake2;
		return 1;
	case ST_Wake2:
		swprintf(dialogbuf,tbuflen,szDialog_Wake3);
		story=ST_Wake3;
		return 1;
	case ST_Wake3:
		swprintf(dialogbuf,tbuflen,szDialog_Wake4);
		story=ST_Wake4;
		return 1;
	case ST_Wake4:
		statusbuf[0]=0;
	...
	case ST_32F11:
		...
		dialogY=0;
		swprintf(dialogbuf,tbuflen,szDialog_Story32F2);
		story=ST_32F2;
		return 1;
	case ST_32F2:
		target=CT_Null;
	...
	case ST_40F13:
		...
		swprintf(statusbuf,tbuflen,szStatus_Story);
		dialogY=7;
		swprintf(dialogbuf,tbuflen,szDialog_Story40F2);
		story=ST_40F2;
		return 1;
	case ST_40F2:
	...
	case ST_40F23:
		...
		swprintf(statusbuf,tbuflen,szStatus_Story);
		dialogY=7;
		swprintf(dialogbuf,tbuflen,szDialog_Story40F3);
		story=ST_40F3;
		return 1;
	case ST_40F3:
	...
	case ST_40F33:
		...
		swprintf(statusbuf,tbuflen,szStatus_Story);
		dialogY=7;
		swprintf(dialogbuf,tbuflen,szDialog_Story40F4);
		story=ST_40F4;
		return 1;
	case ST_40F4:
	...
	case ST_40F43:
		...
		swprintf(statusbuf,tbuflen,szStatus_Story);
		dialogY=7;
		swprintf(dialogbuf,tbuflen,szDialog_Story40F5);
		story=ST_40F5;
		return 1;
	case ST_40F5:
	...
	case ST_40F51:
		...
		swprintf(statusbuf,tbuflen,szStatus_Story);
		dialogY=7;
		swprintf(dialogbuf,tbuflen,szDialog_Story40F6);
		story=ST_40F6;
		return 1;
	case ST_40F6:
		target=CT_Null;
	...
	case ST_42F1:
		target=CT_Zeno49A;
		swprintf(dialogbuf,tbuflen,szDialog_Story42F2);
		story=ST_42F2;
		return 1;
	case ST_42F2:
		target=CT_GoldenKnight;
		...
		swprintf(dialogbuf,tbuflen,szDialog_Story42F3);
		story=ST_42F3;
		return 1;
	case ST_42F3:
		target=CT_Zeno49A;
		...
		playSound(WAV_MagicAttack);
		swprintf(dialogbuf,tbuflen,szDialog_Story42F4);
		story=ST_42F4;
		return 1;
	case ST_42F4:
		target=CT_Null;
	...
	case ST_50F1:
		target=CT_Thief;
		dialogY=0;
		swprintf(dialogbuf,tbuflen,szDialog_Story50F2);
		story=ST_50F2;
		return 1;
	case ST_50F2:
		target=CT_BraveMan;
		...
		playSound(WAV_Zeno);
		dialogY=7;
		swprintf(dialogbuf,tbuflen,szDialog_Story50F3);
		story=ST_50F3;
		return 1;
	case ST_50F3:
		target=CT_Zeno49A;
		dialogY=0;
		swprintf(dialogbuf,tbuflen,szDialog_Story50F4);
		story=ST_50F4;
		return 1;
	case ST_50F4:
		target=CT_BraveMan;
		dialogY=7;
		swprintf(dialogbuf,tbuflen,szDialog_Story50F5);
		story=ST_50F5;
		return 1;
	case ST_50F5:
		target=CT_Zeno49A;
		dialogY=0;
		swprintf(dialogbuf,tbuflen,szDialog_Story50F6);
		story=ST_50F6;
		return 1;
	case ST_50F6:
		target=CT_BraveMan;
		dialogY=7;
		swprintf(dialogbuf,tbuflen,szDialog_Story50F7);
		story=ST_50F7;
		return 1;
	case ST_50F7:
		target=CT_Zeno49A;
		dialogY=0;
		swprintf(dialogbuf,tbuflen,szDialog_Story50F8);
		story=ST_50F8;
		return 1;
	case ST_50F8:
		target=CT_BraveMan;
		dialogY=7;
		swprintf(dialogbuf,tbuflen,szDialog_Story50F9);
		story=ST_50F9;
		return 1;
	case ST_50F9:
		target=CT_Zeno49A;
		dialogY=0;
		swprintf(dialogbuf,tbuflen,szDialog_Story50F10);
		story=ST_50F10;
		return 1;
	case ST_50F10:
		if (stmain.round>1){
	...
	case ST_50F11:
		...
		swprintf(statusbuf,tbuflen,szStatus_Story);
		dialogY=0;
		swprintf(dialogbuf,tbuflen,szDialog_Story50F11);
		story=ST_50F12;
		return 1;
	case ST_50F12:
		story=ST_Finale0;
	...
	case ST_Princess1:
		target=CT_BraveMan;
		swprintf(dialogbuf,tbuflen,szDialog_Princess2);
		story=ST_Princess2;
		return 1;
	case ST_Princess2:
		target=CT_Null;
	...
	case ST_Merchant2F:
		...
		stmain.gold+=1000;
		playSound(WAV_Get);
		swprintf(statusbuf,tbuflen,szStatus_Merchant2F);
		dialogY=-1;
		story=ST_Null;
		return 1;
	default:
...
int storyChoice(int n){//return 1 to redraw //0=cancel, 1~9=choice 1~9, -2=prev, -1=next
	...
	case ST_Intro:
		...
		case 1:
			newGameNormal();
			swprintf(statusbuf,tbuflen,szStatus_Init);
			story=ST_Null;
			return 1;
		case 2:
			newGameEasy();
	...
	case ST_Load:
		...
		if (saveFloor[temp]<0||saveFloor[temp]==stsave[temp].floor){
			st_load(temp);
			target=CT_Null;
			swprintf(statusbuf,tbuflen,szStatus_Load);
			dialogY=-1;
			story=ST_Null;
		}
		return 1;
	...
	case ST_BattleEndless:
		...
		target=CT_Null;
		stmain.life=0;
		swprintf(statusbuf,tbuflen,szStatus_BattleSurrender);
		dialogY=-1;
		story=ST_Null;
		return 1;
	default:
	...
	case ST_OldMan2F:
		...
		swprintf(statusbuf,tbuflen,szStatus_OldMan2F);
		dialogY=-1;
		story=ST_Null;
		return 1;
	case ST_Merchant6F:
		...
		if (stmain.gold>=50){
			...
			playSound(WAV_Get);
			swprintf(statusbuf,tbuflen,szStatus_Bought);
		}else{
			swprintf(statusbuf,tbuflen,szStatus_NoMoney);
		}
		dialogY=-1;
		story=ST_Null;
		return 1;
	...
	case ST_Merchant28F:
		...
		if (stmain.key[KEY_Yellow]>=1){
			...
			swprintf(statusbuf,tbuflen,szStatus_NoKey);
			dialogY=-1;
			story=ST_Null;
		}
		return 1;
	...
	case ST_Altar:
		...
		if (stmain.gold>=temp){
			...
			case 1:
				...
				stmain.life+=temp;
				swprintf(statusbuf,tbuflen,szStatus_AltarLife,temp);
				break;
			case 2:
				temp=(stmain.floor+9)/10*2;
				stmain.attack+=temp;
				swprintf(statusbuf,tbuflen,szStatus_AltarAttack,temp);
				break;
			case 3:
				temp=(stmain.floor+9)/10*4;
				stmain.defend+=temp;
				swprintf(statusbuf,tbuflen,szStatus_AltarDefend,temp);
				break;
			default:
				;
			}
